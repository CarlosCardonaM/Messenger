...
class RegisterViewController: UIViewController {
    ...
    @objc private func registerButtontapped() {
        ...
        DatabaseManager.shared.userExists(with: email, completion: { [weak self] exists in
            ...
            guard !exists else {
                ...
                // User already exists
                strongSelf.alertUserLoginError(message: "Looks like a user account for that email address already existst")
                return
            }
    ...
    func alertUserLoginError(message: String = "Please enter all information create a new account.") {
...
extension RegisterViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func presentPhotoActionSheet() {
        let actiionSheet = UIAlertController(title: "Profile Picture", message: "How would you like to select a picture", preferredStyle: .actionSheet)
        
        actiionSheet.addAction(UIAlertAction(title: "Cancel", style: .cancel, handler: nil))
        
        actiionSheet.addAction(UIAlertAction(title: "Take Photo", style: .default, handler: { [weak self] _ in
            self?.presentCamera()
        }))
        actiionSheet.addAction(UIAlertAction(title: "Choose Photo", style: .default, handler: { [weak self] _ in
            self?.presentPhotoPicker()
        }))
        
        present(actiionSheet, animated: true)
    }
